...
const config = {
  ...
  // Visibility filters
  excludeExternals: false, // Required to include types from @polymeshassociation/polymesh-types
  ...
  enumMembersFormat: 'htmlTable', // Enum members as tables
  propertyMembersFormat: 'htmlTable', // Object properties as tables
  typeDeclarationFormat: 'htmlTable', // Type declarations as tables
  interfacePropertiesFormat: 'htmlTable', // Interface properties as tables
  classPropertiesFormat: 'list', // Class properties as a list
